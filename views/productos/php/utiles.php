...
.text-content{    position: absolute;    bottom: -30px;    padding: 20px;    background-color: #AED6F1;    width: calc(100% - 20px);    left: 50%;    transform: translateX(-50%);    border-radius: 10px;    box-shadow: 1px 1px 8px rgba(0,0,0,0.08);/* padding-top: 50px; */}

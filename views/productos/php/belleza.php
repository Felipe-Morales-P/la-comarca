...
.text-content{    position: absolute;    bottom: -30px;    padding: 20px;    background-color: #D2B4DE;    width: calc(100% - 20px);    left: 50%;    transform: translateX(-50%);    border-radius: 10px;    box-shadow: 1px 1px 8px rgba(0,0,0,0.08);/* padding-top: 50px; */}
...
<div class="center mt-5">
    <div class="card pt-3" >
            <p style="font-weight: bold; color: #0F6BB7; font-size: 22px;">BELLEZA</p>
        <div class="container-fluid p-2" style="background-color: #EBDEF0;">
